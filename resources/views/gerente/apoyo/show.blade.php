	...
	<div class="panel panel-primary panel-apoyo">
        ...
        <div class="panel-body"> 
            ...
            <ul id="myTab" class="nav nav-tabs nav_tabs">                            
                ...
                <li ><a href="#apoyo" data-toggle="tab">{{trans('display.apoyo')}}</a></li>
            ...
            <div id="myTabContent" class="tab-content">
                <div class="container-fluid tab-pane fade in active" id="actividad">  
                    ...
                    <div class="div_button_edit">                               
                        <a class="btn btn-primary button_edit" href="{{route('actividad.edit', $apoyo->id_actividad_fk)}}" title="Modificar datos de actividad"><spam class="glyphicon glyphicon-pencil icon_edit"></spam></a>
                    </div> 
                    <div>                       
                        <label class="control-label">{{trans('display.supervisor')}}</label>
                        {{$apoyo->id_supervisor_fk}}
                    </div>
                ...
                <div class="container-fluid tab-pane fade" id="apoyo">
                    <hr>
                    <div class="div_button_edit">
                        <a class="btn btn-primary button_edit" href="{{route('apoyo.edit', $apoyo->id_actividad_fk)}}" title="Modificar datos de actividad"><spam class="glyphicon glyphicon-pencil icon_edit"></spam></a>
                    </div>
                    <div>                       
                ...
                <div class="container-fluid tab-pane fade" id="involucrados">
                    ...
                    <div class="div_button_edit">                               
                        <a class="btn btn-primary button_edit" href="{{route('actividad_empleado.edit', $apoyo->id_actividad)}}" title="Modificar datos de actividad"><spam class="glyphicon glyphicon-pencil icon_edit"></spam></a>
                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                {{ csrf_field() }}
                    ...
                    <input type="hidden" name="tipo" value="{{$apoyo->tipo}}">

                    <input type="hidden" name="id_actividad_fk" value="{{$apoyo->id_actividad}}">
            ...
            <div class="modal-footer">
                ...
                {!! Form::close() !!}
                    ...
                    <br>
                        ...
                        <input type="hidden" name="tipo_actividad" value="apoyo">
                        <input type="hidden" name="nombre_actividad" value="{{$apoyo->nombre}}">
                        @foreach($involucrados as $involucrado)
