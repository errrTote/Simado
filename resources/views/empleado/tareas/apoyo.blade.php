        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                {{ csrf_field() }}
                    ...
                    <input type="hidden" name="id_actividad_fk" value="{{$apoyo->id_actividad_fk}}">
            ...
            <div class="modal-footer">
                ...
                {!! Form::close() !!}
                    ...
                    {{ csrf_field() }}
                        <input type="text" name="texto" autofocus="autofocus" placeholder="Puede escribir aqui su comentario sobre la actividad" class="form-control">
                    <br>
