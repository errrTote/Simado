...
<head class="maqueta">
  <meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="{{ asset('librerias/bower_components/bootstrap-calendar/css/calendar.css')}}">
    ...
    <script src="{{ asset('librerias/bower_components/bootstrap-calendar/js/language/es-ES.js')}}"></script>
    <script src="{{ asset('librerias/js/main.js') }}" ></script>    
    <script src="{{ asset('librerias/bower_components/underscore/underscore-min.js')}}"></script>
    <script async src="{{ asset('librerias/bower_components/bootstrap-calendar/js/calendar.js')}}"></script>
    <!-- Languaje -->
